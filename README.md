...
- `BrightSign-Website`: A BrightSign script that displays a specified website.
...
- Warning: Apple’s TextEdit app will break your scripts! It will silently convert straight quotes to “smart quotes” and other substitutions that corrupt the code. 
